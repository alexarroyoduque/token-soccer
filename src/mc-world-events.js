    ...
    return html`
      <mc-template>
        ...
        <div slot="main" class="button-container">
          ...
          <mc-button-core
            title=${t('main-world-tour-events-leagues')}
            description=${t('main-world-tour-events-leagues-description')}
          ...
          <mc-button-core
            title=${t('main-world-tour-events-challenges')}
            description=${t('main-world-tour-events-challenges-description')}
          ...
          <mc-button-core
            ...
            description=${t('main-world-tour-events-duels-description')}
